...
.pagination a:hover:not(.active) {background-color:#ddd;}
 ...
 <form method="get" action="search.php">
    ...
    $sql="select  * from `car_list` where brand_id=$id LIMIT {$offset},{$limit}";
           ...
           <img src="Seller/'.$image.' " alt="" width="249px" height="270px">
            ...
            if($noResult) {
                echo '<div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <p class="display-4">Sorry In this Brand No items available.</p>
...
$sql1="select * from car_list where brand_id=$id ";
...
if(mysqli_num_rows($result)>0){
  ...
  if($page>1){
    echo '<a href="Brandview.php? page='.((int)$page-1).' & brandid='.$id.'">Prev</a>';
  }
...
echo '<a class="'.$active.'" href="Brandview.php?page='.$m.' & brandid='.$id.'">'.$m.'</a>';
  }
  if($total_page>$page){
    echo '<a  href="Brandview.php?page='.((int)$page+1).' & brandid='.$id.'" >Next</a>';
  }
