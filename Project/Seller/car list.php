...
<body>
  ...
  $offset=($page-1)*$limit;
    $sql="select * from `car_list` where seller_id=$userId LIMIT {$offset},{$limit}";
...
if(mysqli_num_rows($result)>0){
  ...
  if($page>1){
    echo '<a href="car list.php?page='.($page-1).'">Prev</a>';
  }
...
echo '<a class="'.$active.'" href="car list.php?page='.$m.'">'.$m.'</a>';
  }
  if($total_page>$page){
    echo '<a  href="car list.php?page='.($page+1).'">Next</a>';
  }
