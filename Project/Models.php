...
.pagination a:hover:not(.active) {background-color:#ddd;}
    ...
    <div class="container my-3 mb-5">
        <h2 style="text-align:center; text-transform: uppercase;"><span id="catTitle">Models</span></h2>
            <div class="row">
              ...
              $offset=($page-1)*$limit;
            $sql="select * from `model_list`  LIMIT {$offset},{$limit}";
...
if(mysqli_num_rows($result)>0){
  ...
  if($page>1){
    echo '<a href="Models.php?page='.($page-1).'">Prev</a>';
  }
...
echo '<a class="'.$active.'" href="Models.php?page='.$m.'">'.$m.'</a>';
  }
  if($total_page>$page){
    echo '<a  href="Models.php?page='.($page+1).'">Next</a>';
  }
