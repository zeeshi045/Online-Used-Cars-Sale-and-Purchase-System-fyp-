...
?>
    ...
    if(isset($_GET['search']))
    {
        ...
        $query =   "Select c.id,c.name,c.date_created,b.bname,cat.catname,s.sname from car_list c INNER JOIN brand_list b ON c.brand_id=b.id INNER JOIN category_list cat ON c.category_id=cat.id INNER JOIN seller s ON c.seller_id=s.id where sname LIKE '%$filtervalues%'";
