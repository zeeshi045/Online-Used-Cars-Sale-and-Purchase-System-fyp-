...
?>
      ...
      <section class="home-section">
        <nav>
          <div class="sidebar-button">
            ...
            <span class="dashboard">Car Models</span>
          </div>
          <form method="get" action="search.php" style="width:600px">
          <div class="search-box">
            <input type="text" id="search" class="form-control" name="search"placeholder="Enter Model name">
        ...
        <div class="home-content">
          ...
          <div class="sales-boxes">
            <div class="recent-sales box">
              <div class="title">List of Models</div>
              <div>
                <div class="button">
                    <a href="addmodel.php">+Add New Model</a>
                  </div>
              </div>
              <br>
  ...
  $limit=5;
    ...
    $offset=($page-1)*$limit;
    $sql= "Select m.id,m.mname, m.image,c.bname from model_list m INNER JOIN brand_list c where m.brand_id=c.id  LIMIT {$offset},{$limit} ";
...
if(mysqli_num_rows($result)>0){
  ...
  if($page>1){
    echo '<a href="model.php?page='.($page-1).'">Prev</a>';
  }
...
echo '<a class="'.$active.'" href="model.php?page='.$m.'">'.$m.'</a>';
  }
  if($total_page>$page){
    echo '<a  href="model.php?page='.($page+1).'">Next</a>';
  }
    ...
    <div class="footer-basic">
            <footer>
                ...
                <ul class="list-inline">
                    ...
                    <li class="list-inline-item"><a href="model.php">car models</a></li>
                </ul>
