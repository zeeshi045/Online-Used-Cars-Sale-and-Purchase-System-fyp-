...
if(isset($_POST['submit'])){
  ...
  if(count($error)==0){
    $sql="update `model_list` set id=$id,mname='$name',image=' $img_des',brand_id='$brand_id' where id=$id";
...
<div class="sidebar">
        ...
        <div class="home-content">
          ...
          <div class="sales-boxes">
            <div class="recent-sales box">
              <div class="title">Update Model</div>
              <?php
            $sql="select * from `model_list` where id=$id ";
            $res=mysqli_query($mm,$sql);
              ...
              <div class="container">
                <form action="" method="post" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="col-75">
                      <input type="text" id="name" name="name" placeholder="Model name." value="<?php echo $row['mname'];?>">
                  ...
                  <div class="row">
                    ...
                    <div class="md-3">
                        <input  style="margin-top: 17px;" type="file"  name="image" placeholder="" required><br>
  ...
  $select="";
                 ...
                 echo "<option {$select} value='{$row1['id']}'>{$row1['bname']}</option>";
