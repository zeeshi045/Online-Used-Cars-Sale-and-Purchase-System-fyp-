...
if(isset($_POST['submit'])){
  ...
  $error=array();
  $u="select mname from `model_list` where mname='$name'";
$uu=mysqli_query($mm,$u);
  ...
  $sql="insert into `model_list`(mname,image, brand_id) values ('$name','$img_des','$brand_id' )";
              ...
              <div class="container">
                <form action="" method="post" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="col-75">
                      <input type="text" id="name" name="name" placeholder="Model name." requried>
                ...
                <br>
                  ...
                  <div class="row">
                    ...
                    <div class="col-75">
                        <input style="margin-top: 17px;" type="file" id="myfile" name="image" placeholder="" required>
