      ...
      <section class="home-section">
        <nav>
          ...
          <div class="search-box">
            <input type="text" id="search" class="form-control" name="search"placeholder="Enter Brand name">
        ...
        <div class="home-content">
          ...
          <div class="sales-boxes">
            <div class="recent-sales box">
              <div class="title">List of brands</div>
              <div>
                <div class="button">
...
if(mysqli_num_rows($result)>0){
  ...
  if($page>1){
    echo '<a href="brand.php?page='.($page-1).'">Prev</a>';
  }
...
echo '<a class="'.$active.'" href="brand.php?page='.$m.'">'.$m.'</a>';
  }
  if($total_page>$page){
    echo '<a  href="brand.php?page='.($page+1).'">Next</a>';
  }
    ...
    <div class="footer-basic">
            <footer>
                ...
                <ul class="list-inline">
                    ...
                    <li class="list-inline-item"><a href="brand.php">car brands</a></li>
