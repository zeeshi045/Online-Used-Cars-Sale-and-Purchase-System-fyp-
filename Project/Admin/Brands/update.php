...
if(isset($_POST['submit'])){
  ...
  if(count($error)==0){
    $sql="update `brand_list` set id=$id,bname='$name',image=' $img_des' where id=$id";
              ...
              <div class="container">
                <form action="" method="post"  enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="col-75">
                      <input type="text" id="name" name="name" value="<?php echo $row['bname'];?>" >
                 ...
                 <br><br>
                  <div class="row">
                    ...
                    <div class="md-3">
                        <input  style="margin-top: 17px;" type="file"  name="image" placeholder="" ><br>
