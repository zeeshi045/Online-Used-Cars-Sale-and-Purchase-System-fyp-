...
if(count($error)==0){
  $sql="insert into `category_list` (catname,description) values ('$name','$des' )";
              ...
              <div class="container">
                <form action="" method="post">
                  <div class="row">
                    ...
                    <div class="col-75">
                      <input type="text" id="name" name="name" placeholder="Cat name..">
                  ...
                  <div class="row">
                    ...
                    <div class="col-75">
                      <textarea id="de" name="de" placeholder="Write something.."  style="height:200px"></textarea>
